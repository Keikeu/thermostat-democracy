...
import { LiveSubscription } from "@/components/custom/live-subscription";
  ...
  return (
    <>
      ...
      <main className="flex flex-col max-w-[1024]">
        ...
        <p>
          {numberOfVotes === 0 ? "No" : numberOfVotes}{" "}
          {numberOfVotes === 1 ? "response" : "responses"} so far. The data
        ...
        {!!votes.length && (
          <>
            <section>
              ...
              <p>
                We calculate <b>discomfort score</b> for each possible
                thermostat setting.
              </p>
              <ul className="list-disc pl-4 py-4">
                <li>
                  If the temperature matches your ideal, discomfort is zero.
                </li>
                <li>
                  If it falls within your comfort range, discomfort is low.
                </li>
                <li>
                  If it falls outside your range, discomfort increases the
              ...
              <div className="flex gap-2 md:gap-8 my-8 flex-wrap md:flex-nowrap">
                ...
                <ReportCard
                  label="Comfortable for"
                  value={sweetSpotComfortableFor}
                />
              </div>
            ...
            <section>
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p>
                    In summer, lighter clothing shifts comfort ranges. In
                    winter, heavier clothing shifts them again. Expect seasonal
                    drift.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    Consider buying blankets for people running cold and small
                    desk fans for those running hot.
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    ...
                    thermostats, consider designating some spaces as slightly
                    warmer and some as slightly cooler than The Sweet Spot.
                  </p>
                </div>
              </div>
            </section>
